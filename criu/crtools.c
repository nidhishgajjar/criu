...
usage:
	...
	pr_msg("\n"
	       ...
	       "  --external-dirty-list FILE\n"
	       "                        consume an externally-computed dirty page list\n"
	       "                        (text, one '<start_hex>,<len>' per line); requires\n"
	       "                        --prev-images-dir; mutually exclusive with --track-mem\n"
